...
public class Hotel_2SearchOotyTests extends BaseClassTest {
    ExtentTest test;
    ...
    public void init(){
        ...
        test = reports.createTest("Hotel_2SearchOotyTests");
    }
    ...
    /*    hotelsMenuPage.clickCheckOut();
        ...
        Thread.sleep(1000);
        //input location
        hotelsMenuPage.enterHotelArea("Hotel Lakeview"); //"Ooty");
        Thread.sleep(1500);
        test.log(Status.INFO, "Entered location: Ooty");
  ...
  /*  @Test (priority = 2)
    ...
    public void guestDetails() throws InterruptedException {
        ...
        //Enter guest details
        hotelBookingPage.enterFirstName("Tinah"); //first name
        test.log(Status.INFO, "entered first name");
        hotelBookingPage.enterLastName("Peters"); //last name
        test.log(Status.INFO, "entered last name");
        hotelBookingPage.enterEmail("Tina@yhoo.com"); //email
